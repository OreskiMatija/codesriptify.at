...
<a name="top"></a>
    	...
    	<div id="headerTop">
        	<div class="wrapper">
            	...
            	<div id="headerTopRight">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="references.php"><img src="images/de.png" alt="DE" title="DE"></a>
                    <a href="EN/references.php"><img src="images/uk.png" alt="UK" title="UK"></a>
                    <a href="HR/references.php"><img src="images/hr.png" alt="HR" title="HR"></a>
                </div>
            </div>
        </div>
    ...
    <footer id="footer" class="negative">
        ...
        <div class="wrapper" id="footerBottom">
        	...
        	<p>Copyright @ ITAcademy // <a href="policy.php">privacy / cookie policy</a> </p>

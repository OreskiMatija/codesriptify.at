...
$(document).ready(function() {
    ...
    $(document).on('click', '#facebook', function() {
        swal('Sorry! It is still developing :(');
    });
...
<a name="top"></a>
    	...
    	<div id="headerTop">
        	<div class="wrapper">
            	...
            	<div id="headerTopRight">
                    ...
                    <a href="HR/contact.php"><img src="images/hr.png" alt="HR" title="HR"></a>
                </div>
            </div>
        </div>
    	...
    	<div class="wrapper">
        	...
        	<main id="mainFull">
                ...
                <form action="#" method="post">
                    ...
                    <div class="form-group">
                        <label for="subject"><h6>Nachricht</h6></label>
    ...
    <?php
        if($status == 1){
            echo '<script>swal("Sehr gut!", "Ihre E-Mail wurde erfolgreich gesendet!", "success")</script>;';
        }
    ?>

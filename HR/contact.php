...
<title>Codescriptify - kontakt</title>
<meta name="description" content="Software & Graphic design - kontakt" />
...
<a name="top"></a>
    	...
    	<div id="headerTop">
        	<div class="wrapper">
            	...
            	<div id="headerTopRight">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="../contact.php"><img src="../images/de.png" alt="DE" title="DE"></a>
                    <a href="../EN/contact.php"><img src="../images/uk.png" alt="UK" title="UK"></a>
                    <a href="contact.php"><img src="../images/hr.png" alt="HR" title="HR"></a>
                </div>
            </div>
        </div>
        	...
        	<main id="mainFull">
                ...
                <form action="#" method="post">
                    <div class="form-group">
                        <label for="firstName"><h6>Ime</h6></label>
                        <input type="text" id="firstName" name="firstName" required>
                    </div>
                    <div class="form-group">
                        <label for="lastName"><h6>Prezime</h6></label>
                    ...
                    <div class="form-group">
                        <label for="subject"><h6>Poruka</h6></label>
                        <textarea id="subject" name="subject" required></textarea>
                    </div>
                    <div class="form-group">
                        <input id="submit" name="submit" type="submit" value="Zatraži ponudu">
                    </div>
                </form>
    ...
    <?php
        if($status == 1){
            echo '<script>swal("Odlično!", "Vaš emal je uspješno poslan!", "success")</script>;';
        }
    ?>
